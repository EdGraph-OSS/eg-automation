...
def main() -> None:
    ...
    act_endpoints = client.get_edfi_instance_endpoints(act_external_instance_id, school_year)
    act_api_client = client.get_edfi_instance_application(
    ...
    if not state.job_id:
        job = client.create_datasync_job(
            DataSyncCreateJobRequest(
